...
void PanelNoteOn(Panel *p, std::uint8_t note, std::uint8_t velocity);  // note-on: drive engine + envelope playhead
void PanelNoteOff(Panel *p, std::uint8_t note);        // note-off: release + playhead release segment
